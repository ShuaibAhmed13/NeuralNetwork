...
//        System.out.println(nn.testXOR(to) + "%");
        ...
        nn.train(100, .02, to);
        //50 epochs, .03 lr = 0.8154 accuracy
        //10 epochs, .03 lr = 0.6968 accuracy
        //10 epochs, .1 lr = 0.5335 accuracy
        //10 epochs, .05 lr = 0.6369 accuracy
        //10 epochs, .02 lr = 0.7491 accuracy
        //10 epochs, .01 lr = 0.4607 accuracy
        //10 epochs, .04 lr = 0.6484 accuracy
        //50 epochs, .02 lr = 0.8695 accuracy
//        System.out.println("Input is number 5");
//        nn.forward(to.get(0).input);
//        max = 0;
//        index = 0;
